<template>
    <section id="relume" class="px-[5%] py-16 md:py-24 lg:py-28 bg-green-100">
  <div class="container">
    <div
      class="mb-12 grid grid-cols-1 items-start gap-5 md:mb-18 md:grid-cols-2 md:gap-x-12 lg:mb-20 lg:gap-x-20"
    >
      <h2 class="text-4xl font-bold leading-[1.2] md:text-5xl lg:text-5xl">
        Your Journey Begins: Discover How to Book with Tusafiri
      </h2>
      <p class="md:text-md">
        Tusafiri's travel plans offer unmatched convenience and cost savings. Experience personalized adventures tailored to your preferences.
      </p>
    </div>
    <div class="grid grid-cols-1 items-start gap-y-12 md:grid-cols-3 md:gap-x-8 lg:gap-x-12">
      <div>
        ...
        <p>
            Select where and when you want to travel.
        </p>
      ...
      <div>
        ...
        <h3 class="mb-3 text-xl font-bold md:mb-4 md:text-2xl">
            Step 2: Customize Your Travel Experience
        </h3>
        <p>
            Tailor your itinerary with activities that excite you.
        </p>
        <div class="mt-6 flex items-center gap-4 md:mt-8">
          <button
            class="focus-visible:ring-border-primary inline-flex items-center justify-center whitespace-nowrap ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border-0 text-text-primary gap-2 p-0"
      ...
      <div>
        ...
        <h3 class="mb-3 text-xl font-bold md:mb-4 md:text-2xl">
            Step 3: Review and Confirm Your Travel Plan
        </h3>
        <p>
            Double-check your selections and finalize your booking.
        </p>
        <div class="mt-6 flex items-center gap-4 md:mt-8">
          <button
            class="focus-visible:ring-border-primary inline-flex items-center justify-center whitespace-nowrap ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border-0 text-text-primary gap-2 p-0"
